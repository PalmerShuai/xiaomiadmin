...
<el-upload
  ...
  <el-form-item>
    <el-button type="primary" @click="onSubmit(form.id)">立即修改</el-button>
...
form:{
  ...
  methods:{
      gitone(){
            ...
            axios.get('/goods/data/'+id).then(res=>{
       this.form.title = res.data.list.title;
       this.form.desc = res.data.list.desc;
       this.form.price =res.data.list.price;
       this.form.hot =res.data.list.hot;
       this.imageUrl =res.data.list.imgurl;
       this.form.id =res.data.list._id;
            })
         },
      UploadImage(param) {
